  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: {
          // Shifted from a cool #121316 to match the new site-wide
          // gradient's dark end (Raisin Black #242124) - every solid
          // fill using this token (nav, cards, sticky bars, hero
          // fades) now blends into the gradient instead of showing as
          // a mismatched flat rectangle against it.
          DEFAULT: '#242124',
          card: '#2E2B2D',
        },
      },
